...
This mechanism has been integrated into Bitcore-Node-GALR which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/GALR-Project/insight-api-galr#web-socket-api](https://github.com/GALR-Project/insight-api-galr#web-socket-api) 
* API: [https://github.com/GALR-Project/insight-api-galr#swifttx-transactions](https://github.com/GALR-Project/insight-api-galr#swifttx-transactions) 
...
By default, the GALR Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the GALR Core daemon:
