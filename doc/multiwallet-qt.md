...
In order to support loading of multiple wallets in galr-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is galr.cpp.
...
Changes to galr.cpp
----------------------
galr.cpp is the entry point into galr-qt, and as such, will require some minor modifications to provide hooks for
