Contributing to GALR Core
============================

The GALR Core project operates an open contributor model where anyone is
...
The following applies to code changes to the GALR Core project, and is not to be
confused with overall GALR Network Protocol consensus changes.

Whether a pull request is merged into GALR Core rests with the project merge
...
Patches that change GALR consensus rules are considerably more involved than
...
Where a patch set proposes to change the GALR consensus, it must have been
...
The project leader is the release manager for each GALR Core release.
