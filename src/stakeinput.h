...
#ifndef GALR_STAKEINPUT_H
#define GALR_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZGAL() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zGALStake can take two forms
...
public:
    ...
    bool IsZGAL() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZGAL() override { return false; }
};


#endif //GALR_STAKEINPUT_H
