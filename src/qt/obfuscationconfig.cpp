...
// Copyright (c) 2016-2017 The GALR developers
...
void ObfuscationConfig::clickBasic()
{
    ...
    QMessageBox::information(this, tr("Obfuscation Configuration"),
        tr(
            "Obfuscation was successfully set to basic (%1 and 2 rounds). You can change this at any time by opening GALR's configuration screen.")
            .arg(strAmount));
...
void ObfuscationConfig::clickHigh()
{
    ...
    QMessageBox::information(this, tr("Obfuscation Configuration"),
        tr(
            "Obfuscation was successfully set to high (%1 and 8 rounds). You can change this at any time by opening GALR's configuration screen.")
            .arg(strAmount));
...
void ObfuscationConfig::clickMax()
{
    ...
    QMessageBox::information(this, tr("Obfuscation Configuration"),
        tr(
            "Obfuscation was successfully set to maximum (%1 and 16 rounds). You can change this at any time by opening GALR's configuration screen.")
            .arg(strAmount));
