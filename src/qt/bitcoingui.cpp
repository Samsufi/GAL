                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("GALR Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GALR address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and galr: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zGAL"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About GALR Core"), this);
    aboutAction->setStatusTip(tr("Show information about GALR Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GALR"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GALR addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GALR addresses"));
    ...
    openAction->setStatusTip(tr("Open a GALR: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GALR Core help message to get a list with possible GALR command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("GALR Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GALR network", "", count));
}
...
{
    QString strTitle = tr("GALR Core"); // default title
