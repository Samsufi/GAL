...
RESOURCES += src/qt/galr.qrc src/qt/galr_locale.qrc

TRANSLATIONS += src/qt/locale/galr_bg.ts \
                src/qt/locale/galr_de.ts \
                src/qt/locale/galr_en.ts \
                src/qt/locale/galr_es.ts \
                src/qt/locale/galr_fi.ts \
                src/qt/locale/galr_fr.ts \
                src/qt/locale/galr_it.ts \
                src/qt/locale/galr_ja.ts \
                src/qt/locale/galr_pl.ts \
                src/qt/locale/galr_pt.ts \
                src/qt/locale/galr_ru.ts \
                src/qt/locale/galr_sk.ts \
                src/qt/locale/galr_sv.ts \
                src/qt/locale/galr_vi.ts \
                src/qt/locale/galr_zh_CN.ts \
                src/qt/locale/galr_zh_TW.ts
