...
This means one can have an always-on galrd instance running, and another local galrd/galr-qt instance which connects to this node and receives blocks from it.
